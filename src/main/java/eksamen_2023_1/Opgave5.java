...
public class Opgave5 {
    ...
    public static void main(String[] args) {
        ...
        graph.add(new Edge(5, nodes[0], nodes[1]));
        graph.add(new Edge(5, nodes[0], nodes[2]));
        graph.add(new Edge(6, nodes[1], nodes[3]));
        graph.add(new Edge(7, nodes[2], nodes[3]));
        graph.add(new Edge(6, nodes[2], nodes[4]));
        graph.add(new Edge(3, nodes[3], nodes[5]));
        graph.add(new Edge(6, nodes[3], nodes[6]));
        graph.add(new Edge(3, nodes[3], nodes[4]));
        graph.add(new Edge(2, nodes[4], nodes[6]));
        graph.add(new Edge(4, nodes[5], nodes[6]));
